...
#include "helloworld_with_allocator_concept_grpc.h"
#include "helloworld_with_allocator_concept_types.h"
...
using namespace helloworld_with_allocator_concept;
...
int main()
{
    ...
    // TODO change to 0 to get example/test to pass
    return 0;
}
