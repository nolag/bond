    ...
    struct Foo<_Alloc>::Schema
    {
        ...
        public: struct var
        {
            ...
            typedef struct : ::bond::reflection::FieldTemplate<
                ...
                ::bond::reflection::optional_field_modifier,
                Foo<_Alloc>,
                ::bond::maybe<std::basic_string<char, std::char_traits<char>, std::scoped_allocator_adaptor<typename std::allocator_traits<_Alloc>::template rebind_alloc<char> > > >,
                &Foo<_Alloc>::m_str_2,
                &s_m_str_2_metadata
            > {}  m_str_2;
            ...
            typedef struct : ::bond::reflection::FieldTemplate<
                ...
                ::bond::reflection::optional_field_modifier,
                Foo<_Alloc>,
                ::bond::maybe<std::basic_string<wchar_t, std::char_traits<wchar_t>, std::scoped_allocator_adaptor<typename std::allocator_traits<_Alloc>::template rebind_alloc<wchar_t> > > >,
                &Foo<_Alloc>::m_wstr_2,
                &s_m_wstr_2_metadata
            > {}  m_wstr_2;
        ...
        private: typedef typename boost::mpl::push_front<fields0, typename var::m_int64_neg_oct>::type fields1;
        private: typedef typename boost::mpl::push_front<fields1, typename var::m_int64_neg_hex>::type fields2;
        private: typedef typename boost::mpl::push_front<fields2, typename var::m_wstr_2>::type fields3;
        private: typedef typename boost::mpl::push_front<fields3, typename var::m_wstr_1>::type fields4;
        private: typedef typename boost::mpl::push_front<fields4, typename var::m_enum_uint32_max>::type fields5;
        private: typedef typename boost::mpl::push_front<fields5, typename var::m_enum_uint32_min>::type fields6;
        private: typedef typename boost::mpl::push_front<fields6, typename var::m_enum_int32max>::type fields7;
        private: typedef typename boost::mpl::push_front<fields7, typename var::m_enum_int32min>::type fields8;
        private: typedef typename boost::mpl::push_front<fields8, typename var::m_enum3>::type fields9;
        private: typedef typename boost::mpl::push_front<fields9, typename var::m_enum2>::type fields10;
        private: typedef typename boost::mpl::push_front<fields10, typename var::m_enum1>::type fields11;
        private: typedef typename boost::mpl::push_front<fields11, typename var::m_float_7>::type fields12;
        private: typedef typename boost::mpl::push_front<fields12, typename var::m_float_4>::type fields13;
        private: typedef typename boost::mpl::push_front<fields13, typename var::m_float_3>::type fields14;
        private: typedef typename boost::mpl::push_front<fields14, typename var::m_double_5>::type fields15;
        private: typedef typename boost::mpl::push_front<fields15, typename var::m_double_4>::type fields16;
        private: typedef typename boost::mpl::push_front<fields16, typename var::m_double_3>::type fields17;
        private: typedef typename boost::mpl::push_front<fields17, typename var::m_uint64_max>::type fields18;
        private: typedef typename boost::mpl::push_front<fields18, typename var::m_uint64_3>::type fields19;
        private: typedef typename boost::mpl::push_front<fields19, typename var::m_uint32_max>::type fields20;
        private: typedef typename boost::mpl::push_front<fields20, typename var::m_uint32_3>::type fields21;
        private: typedef typename boost::mpl::push_front<fields21, typename var::m_uint16_3>::type fields22;
        private: typedef typename boost::mpl::push_front<fields22, typename var::m_uint16_2>::type fields23;
        private: typedef typename boost::mpl::push_front<fields23, typename var::m_uint8_3>::type fields24;
        private: typedef typename boost::mpl::push_front<fields24, typename var::m_uint8_2>::type fields25;
        private: typedef typename boost::mpl::push_front<fields25, typename var::m_int64_max>::type fields26;
        private: typedef typename boost::mpl::push_front<fields26, typename var::m_int64_4>::type fields27;
        private: typedef typename boost::mpl::push_front<fields27, typename var::m_int32_max>::type fields28;
        private: typedef typename boost::mpl::push_front<fields28, typename var::m_int32_4>::type fields29;
        private: typedef typename boost::mpl::push_front<fields29, typename var::m_int16_5>::type fields30;
        private: typedef typename boost::mpl::push_front<fields30, typename var::m_int16_4>::type fields31;
        private: typedef typename boost::mpl::push_front<fields31, typename var::m_int8_5>::type fields32;
        private: typedef typename boost::mpl::push_front<fields32, typename var::m_int8_4>::type fields33;
        private: typedef typename boost::mpl::push_front<fields33, typename var::m_str_2>::type fields34;
        private: typedef typename boost::mpl::push_front<fields34, typename var::m_str_1>::type fields35;
        private: typedef typename boost::mpl::push_front<fields35, typename var::m_bool_3>::type fields36;
        private: typedef typename boost::mpl::push_front<fields36, typename var::m_bool_2>::type fields37;
        private: typedef typename boost::mpl::push_front<fields37, typename var::m_bool_1>::type fields38;

        public: typedef typename fields38::type fields;
        ...
        Schema()
        {
            ...
            (void)s_m_int64_neg_hex_metadata;
            (void)s_m_int64_neg_oct_metadata;
        }
