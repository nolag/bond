...
namespace test
{
    ...
    struct foo
    {
        ...
        explicit
        foo(const _Alloc<::test::foo<typename _Alloc>>& allocator)
          : m(allocator),
            s(allocator)
        {
        }
    ...
    template <template<typename> typename _Alloc=std::allocator>
    inline void swap(::test::foo<typename _Alloc>& left, ::test::foo<typename _Alloc>& right)
    {
        left.swap(right);
    }
} // namespace test
...
namespace std
{
    template<typename _AllocTo,  template<typename> class _Alloc>
        struct uses_allocator<::test::foo<typename _Alloc>, _AllocTo>
        : is_convertible<typename _AllocTo, typename _Alloc<::test::foo<typename _Alloc>>>
    {};
}
